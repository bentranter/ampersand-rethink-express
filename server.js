...
new Moonboots({
    moonboots: {
        jsFileName: 'ampersand-rethink-express',
        cssFileName: 'ampersand-rethink-express',
...
console.log('Ampersand Rethink Express is running at: http://localhost:' + config.http.port + ' Yep. That\'s pretty awesome.');
